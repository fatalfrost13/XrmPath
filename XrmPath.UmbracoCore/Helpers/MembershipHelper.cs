...
using XrmPath.UmbracoCore.Email;
    ...
    public static class MembershipHelper
    {
        ...
        public static MemberModel GetMember(this IMember member)
        {
            if (member != null)
            {
                ...
                var verificationKey = member.GetMemberValue(UmbracoCustomFields.VerificationKey).ToString();
        ...
        public static EmailStatus SendForgotPassword(string email, int templateId = 0)
        {
            ...
            if (notificationTemplateId > 0)
            {
                ...
                if (membershipModel != null)
                {
                    ...
                    var loginUrl = SiteUrlHelper.GetFullUrl($"{loginPage}?RedirectUrl={changePasswordPage}");
        ...
        public static EmailStatus SendVerifyAccount(MemberModel contactModel, int templateId = 0)
        {
            ...
            var verificationUrl = SiteUrlHelper.GetFullUrl($"{verificationPage}?email={email}&verificationKey={verificationKey}&vue=0");
