    ...
    public static class PageHelper
    {
        ...
        public static PageModel GetPageModel(IPublishedContent content)
        {
            ...
            catch(Exception ex)
            {
                ...
                LogHelper.Error($"XrmPath.Web caught error on PageHelper.GetPageModel(). URL Info: {UrlUtility.GetCurrentUrl()}", ex);
        ...
        public static MetaData GetMetaData(IPublishedContent content)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogHelper.Error($"XrmPath.Web caught error on PageHelper.GetMetaData(). URL Info: {UrlUtility.GetCurrentUrl()}", ex);
                return new MetaData();
            }
        }
        ...
        private static string GetKeywords(IPublishedContent content)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogHelper.Error($"XrmPath.Web caught error on PageHelper.GetKeywords(). URL Info: {UrlUtility.GetCurrentUrl()}", ex);
            }
            return keywords;
        }
        ...
        public static bool UntrackableDestination(int id)
        {
            ...
            catch (Exception ex)
            {
                ...
                LogHelper.Error($"XrmPath.Web caught error on PageHelper.UntrackableDestination(). URL Info: {UrlUtility.GetCurrentUrl()}", ex);
            }
        ...
        public static string GetRedirectUrl(string url)
        {
            ...
            catch(Exception ex)
            {
                ...
                LogHelper.Error($"XrmPath.Web caught error on PageHelper.GetRedirectUrl({url}). URL Info: {UrlUtility.GetCurrentUrl()}", ex);
            }
        ...
        public static bool HandleUrlChange(IPublishedContent content, string note = "")
        {
            ...
            if (autoGeneratedFolder != null)
            {
                ...
                if (!matchingNodes.Any())
                {
                    ...
                    var redirectContent = ServiceUtility.ContentService.Create(redirectName, autoGeneratedFolder.Id, UmbracoCustomTypes.RedirectItem);
                    ...
                    ServiceUtility.ContentService.SaveAndPublish(redirectContent);
                ...
                else
                {
                    ...
                    if (matchingNode != null)
                    {
                        ...
                        ServiceUtility.ContentService.SaveAndPublish(updateContent);
