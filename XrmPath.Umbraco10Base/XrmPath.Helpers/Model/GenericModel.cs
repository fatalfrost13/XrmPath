...
namespace XrmPath.Helpers.Model
{
    public class GenericModel
    {
        ...
        public List<int> Ids { get; set; } = Array.Empty<int>().ToList();         //store list of integers
        public List<string> Values { get; set; } = Array.Empty<string>().ToList();   //store list of strings
        public List<object> Objects { get; set; } = Array.Empty<object>().ToList();    //store list of generic objects
