...
namespace XrmPath.Web.Models
{
    public static class ConfigurationModel
    {
        ...
        public static readonly string SearchableFields = $"{UmbracoCustomFields.NodeName},{UmbracoCustomFields.Title},{UmbracoCustomFields.Body},{UmbracoCustomFields.Description},{UmbracoCustomFields.Grid},{UmbracoCustomFields.Tags},{UmbracoCustomFields.MetaDescription},{UmbracoCustomFields.MetaKeywords},{UmbracoCustomFields.FileTextContent}," +
        ...
        public static readonly string TagFields = $"{UmbracoCustomFields.KeywordTags},{UmbracoCustomFields.MetaKeywords}";
