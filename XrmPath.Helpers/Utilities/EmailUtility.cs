    ...
    public static class EmailUtility
    {
        ...
        public static EmailStatus SendEmail(string toEmail, string fromEmail, string bccEmail, string subject, string emailMessage)
        {
            ...
            catch (Exception ex)
            {
                ...
                //LogHelper.Error<MailMessage>("XrmPath.Helpers caught error on EmailUtility.SendEmail()", ex);
            }
        ...
        public static EmailStatus SendEmail(MailMessage msg)
        {
            ...
            catch (Exception ex)
            {
                ...
                //LogHelper.Warn<string>($"XrmPath.Helpers warning: Failure to send email on EmailUtility.SendEmail to: {emailTo}. Message: {ex}");
            }
        ...
        public static MailMessage GetMailMessage(string toEmail, string fromEmail, string bccEmail, string subject, string emailMessage, string emailTemplate, ListDictionary replacements)
        {
            ...
            catch (Exception ex)
            {
                ...
                //LogHelper.Error<MailMessage>("XrmPath.Helpers caught error on EmailUtility.GetMailMessage()", ex);
            }
            return msg;
        }
